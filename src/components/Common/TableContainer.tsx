...
// Временные заглушки
const ProductsGlobalFilter = () => null;
const CustomersGlobalFilter = () => null;
const OrderGlobalFilter = () => null;
const ContactsGlobalFilter = () => null;
const CompaniesGlobalFilter = () => null;
const LeadsGlobalFilter = () => null;
const CryptoOrdersGlobalFilter = () => null;
const InvoiceListGlobalSearch = () => null;
const TicketsListGlobalFilter = () => null;
const NFTRankingGlobalFilter = () => null;
const TaskListGlobalFilter = () => null;
