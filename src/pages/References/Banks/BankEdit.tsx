...
const BankEdit = () => {
    ...
    const bankId = id === 'new' ? undefined : (id ? parseInt(id) : undefined);
    const isNewBank = id === 'new';
    ...
    document.title = isNewBank 
        ? "Новый банк | Агро ПО"
        : `Редактирование: ${bank?.name || 'Банк'} | Агро ПО`;
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (success) {
                ...
                setSuccessToast({
                    message: 'Банк сохранен',
                    details: 'Данные банка успешно сохранены',
                    isVisible: true
                });
            } else {
            ...
            <div className="page-content">
                <Container fluid>
                    <div className="text-center p-5">
                        ...
                        <p className="mt-2">Загрузка данных банка...</p>
                    </div>
                </Container>
                        ...
                        <Col>
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">
                                    {isNewBank ? 'Новый банк' : 'Редактирование банка'}
                                </h4>
                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        <li className="breadcrumb-item">
                                            <a href="#" onClick={() => navigate('/references/banks')}>
                                                Банки
                                            </a>
                                        </li>
                                        <li className="breadcrumb-item active">
                                            {isNewBank ? 'Создание' : 'Редактирование'}
                                        </li>
                                    </ol>
                                </div>
                            </div>
